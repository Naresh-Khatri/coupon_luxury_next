...
export default function OffersFilters({
  ...
  return (
    <aside className="flex flex-col gap-6 pb-6">
      ...
      {/* Categories */}
      <section>
        <h3 className="mb-3 text-[11px] font-bold uppercase tracking-[0.16em] text-navy">
          Category
        </h3>
              ...
              <li key={cat.slug}>
                ...
                >
                  <Checkbox
                    ...
                    className="data-[state=checked]:!border-gold data-[state=checked]:!bg-gold data-[state=checked]:!text-white"
                  />
...
function RadioRow({
  ...
  return (
    <label
      className={cn(
        "flex cursor-pointer items-center gap-2.5 rounded-md px-2 py-1.5 text-[13.5px] transition-colors",
        checked ? "bg-gold/10 text-navy" : "text-gray-700 hover:bg-gray-50"
      )}
    >
      <RadioGroupItem
        value={value}
