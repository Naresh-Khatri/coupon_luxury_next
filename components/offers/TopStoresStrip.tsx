      ...
      <div className="-mx-1 flex gap-2 overflow-x-auto px-1 pb-1">
        {stores.map((store) => (
          <Link
            ...
            className="group flex shrink-0 flex-col items-center gap-1 rounded-lg border border-gray-200 bg-white px-3 py-2 transition-all hover:border-gold/60 hover:shadow-sm"
          ...
          >
            ...
            <span className="line-clamp-1 max-w-[96px] text-center text-[11px] font-medium text-navy">
              {store.storeName}
            </span>
