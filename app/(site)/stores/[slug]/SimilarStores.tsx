        ...
        {stores.map((store) => (
          <li key={store.id}>
            <Link
              ...
              className="group flex flex-col items-center gap-2 rounded-xl border border-border bg-muted p-4 transition-all hover:border-gold/60 hover:shadow-md"
            >
              <div className="flex h-16 w-full items-center justify-center bg-white/95 rounded-md">
                <Image
              ...
              <span className="line-clamp-1 text-center text-[12px] font-medium text-foreground/80">
                {store.storeName}
              </span>
            </Link>
          </li>
